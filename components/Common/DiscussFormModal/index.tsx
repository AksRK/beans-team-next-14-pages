import s from './discuss-form.module.scss';
...
const DiscussFormModal = () => {
  ...
  return (
    <Modal open={isVisibleDiscussForm} setClose={() => setIsVisibleDiscussForm(false)} childrenAlign={'end'}>
      <div className={`large-container ${s.largeContainerDiscussForm}`}>
        <motion.div
          initial={'initial'}
          animate={'animate'}
          exit={'exit'}
          variants={variants}
          className={s.discussFormModal}
        >
          <div className={s.discussFormModal__head}>
            <h3>{t.modals.headings.discussProject}</h3>
            <button onClick={() => setIsVisibleDiscussForm(false)}>
              <CloseSvg />
            </button>
          </div>
          <div className={s.discussFormModal__body}>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              <FormItem
                ...
                className={s.discussFormModal__formItemSmallWrp}
              >
                <TextArea
              ...
              <div>
                ...
                <div className={s.discussFormModal__paymentTermLaterWrp}>
      ...
      {isThanksWindowOpen && (
        <motion.div
          ...
          animate={'animate'}
          exit={'exit'}
          className={s.discussFormModalThanks}
        >
          {!isSuccess && !isError && (
