    ...
    <div className={'how-we-work'}>
      ...
      <AnimatePresence>
        <ul className={`how-we-work-list ${isTheirMethod ? ' how-we-work-list--their-method ' : ''}`}>
            ...
            <div>
              ...
              <AnimatePresence>
                {isTheirMethod && (
                  ...
                  >
                    <div className={'how-we-work-list__red-text'}>{t.aboutTeam.howWeWork.items.gettingAcquainted[2]}</div>
                  </m.div>
                )}
              </AnimatePresence>
            </div>
          ...
          >
            <div>
              <span className={isTheirMethod ? 'how-we-work-list__through-text' : ''}>{t.aboutTeam.howWeWork.items.transform[0]} </span>
              <span className={isTheirMethod ? 'how-we-work-list__through-text' : ''}>
              ...
              <AnimatePresence>
                {isTheirMethod && (
                  <m.div
                    ...
                    exit={{ height: 0, opacity: 0 }}
                  >
                    <div className={'how-we-work-list__red-text'}>{t.aboutTeam.howWeWork.items.transform[2]} </div>
                  </m.div>
                )}
              </AnimatePresence>
            </div>
              ...
              <AnimatePresence>
                {isTheirMethod && (
                  <m.div
                    ...
                    exit={{ height: 0, opacity: 0 }}
                  >
                    <div className={'how-we-work-list__red-text'}>{t.aboutTeam.howWeWork.items.check[2]}</div>
                  </m.div>
                )}
              </AnimatePresence>
            </div>
